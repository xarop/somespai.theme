...
if ( ! class_exists( 'somespai_Template' ) ) {
	class somespai_Template {
		...
		public function move_homepage_sections() {
			...
			if ( false !== $homepage_content ) {
				add_action( 'somespai_before_homepage_content', 'storefront_homepage_content', 10 );
			}

			if ( false !== $homepage_featured ) {
				add_action( 'somespai_before_homepage_content', 'storefront_featured_products',	20 );
			}
		}
		...
		public function primary_navigation_wrapper() {
			echo '<section class="somespai-primary-navigation">';
		}
