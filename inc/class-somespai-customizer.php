...
if ( ! class_exists( 'somespai_Customizer' ) ) {

class somespai_Customizer {
	...
	public function __construct() {
		...
		add_filter( 'storefront_setting_default_values', array( $this, 'get_somespai_defaults' ) );
	 ...
	 * @return array
	 */
	public function get_somespai_defaults( $defaults = array() ) {
		...
		return apply_filters( 'somespai_default_settings', $defaults );
	}

	/**
	 * Set default Customizer settings based on Storechild design.
	 * @uses get_somespai_defaults()
	 * @return void
	 */
	public function edit_default_customizer_settings( $wp_customize ) {
		foreach ( somespai_Customizer::get_somespai_defaults() as $mod => $val ) {
	...
	public function default_theme_settings() {
		...
		foreach ( self::get_somespai_defaults() as $mod => $val) {
...
return new somespai_Customizer();